...
const FluidAnimation = (props: any) => {
  const {
    SIM_RESOLUTION: t = 128,
    DYE_RESOLUTION: r = 1440,
    CAPTURE_RESOLUTION: a = 512,
    DENSITY_DISSIPATION: o = 3.5,
    VELOCITY_DISSIPATION: l = 2,
    PRESSURE: c = 0.1,
  ...
  useEffect(() => {
    ...
    function getWebGLContext (canvas) {
        ...
        console.log(gl, 'getWebGLContext');
        return {
            gl,
            ext: {
                formatRGBA,
    ...
    window.addEventListener('mousedown', (e) => {
      ...
      document.body.addEventListener('mousemove', function e(t) {
        const r = pointers[0],
          i = scaleByPixelRatio(t.clientX),
          n = scaleByPixelRatio(t.clientY),
          a = generateColor();
          update(),
          updatePointerMoveData(r, i, n, a),
      ...
      window.addEventListener('mousemove', (e) => {
        const t = pointers[0],
          ...
          n = t.color;
        updatePointerMoveData(t, r, i, n);
      });
      document.body.addEventListener('touchstart', function e(t) {
        const r = t.targetTouches,
          i = b[0];
        for (let e = 0; e < r.length; e++) {
          const t = scaleByPixelRatio(r[e].clientX),
            n = scaleByPixelRatio(r[e].clientY);
          update(), updatePointerDownData(i, r[e].identifier, t, n);
        }
      ...
      window.addEventListener('touchstart', (e) => {
        ...
        for (let e = 0; e < t.length; e++) {
          const i = scaleByPixelRatio(t[e].clientX),
            n = scaleByPixelRatio(t[e].clientY);
          updatePointerDownData(r, t[e].identifier, i, n);
        }
      });
        ...
        (e) => {
          ...
          for (let e = 0; e < t.length; e++)
            updatePointerMoveData(
              r,
              scaleByPixelRatio(t[e].clientX),
              scaleByPixelRatio(t[e].clientY),
              r.color
            );
        },
        !1
  ...
  return <canvas id="fluid" className="w-screen h-screen" ref={canvasRef} />;
};
